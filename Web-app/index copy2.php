...
<!--        <link href="css/responsive.css" rel="stylesheet">  -->
    ...
    <body>
        ...
        <header class="main_header_area">
            <nav class="navbar navbar-default navbar-fixed-top" id="main_navbar">
               ...
               <div class="form-check form-switch">
                 <input class="form-check-input" type="checkbox" id="dayNightSwitch">
                 <label class="form-check-label" for="dayNightSwitch">Toggle Day/Night<label>
               </div>
            </div>
        ...
        <section class="slider_area row m0">
            <div class="slider_inner">
                <div class="camera_caption">
                    <h2 class="wow fadeInUp animated">Make Your Shopping Easy2</h2>
        ...
        <!--==========End Slider area==========-->
        <img src="img/ecom-banner2.png" alt="Custom Banner" class="banner-img">  
